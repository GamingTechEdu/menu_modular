...
import 'package:menu_modular/src/api/api_client.dart';
import 'package:menu_modular/src/common/tabbar_back.dart';
...
class _SimcardEditState extends State<SimcardEdit> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        children: [
          TabBarBack(onBack: widget.onBack, title: "SIMCARD / editar"),
          Positioned(
            top: 45,
            bottom: 0,
            left: 0,
